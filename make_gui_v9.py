...
def guibuild():
    ...
    second_col = [
                [sg.Column([[sg.Text('Set Up Window',font=("Helvetica", 12, "bold"))]], justification='c')],
                 ...
                 [sg.Radio("AC and DC", "acdc", key='-ACDC_SELECT-',default=True),
                      sg.Radio("AC Only", "acdc", key='-AC_SELECT-'),
                      sg.Radio("DC Only", "acdc", key='-DC_SELECT-'),
                      sg.Button('Continue',key='-ACDC_CONT-')],
                 [sg.Radio("New Setup", "last", key='new', default=True),
                      sg.Radio("Use Last Values", "last", key='old'),
                      sg.Button('Continue',key='-LAST_CONT-')],
